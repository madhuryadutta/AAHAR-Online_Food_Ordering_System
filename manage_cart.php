    ...
    if (isset($_POST['Add_To_Cart'])) {
        if (isset($_SESSION['cart'])) {
            ...
            if (in_array($_POST['Item_Name'], $myitems)) {
                ...
                $_SESSION['cart'][$count] = ['Item_Id'=>$_POST['Item_Id'], 'Item_Name'=>$_POST['Item_Name'], 'Price'=>$_POST['Item_Price'], 'Quantity'=>$_POST['Quantity']];
            ...
            $_SESSION['cart'][0] = ['Item_Id'=>$_POST['Item_Id'], 'Item_Name'=>$_POST['Item_Name'], 'Price'=>$_POST['Item_Price'], 'Quantity'=>$_POST['Quantity']];
            // echo "<script> alert('Item Added');
            //     window.location.href='index.php';
            //     </script>";
            $_SESSION['cart_added_alert'] = true;
